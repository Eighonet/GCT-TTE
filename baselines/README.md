This directory contains benchmark baselines' implementations. You can download the weights via this link: https://sc.link/L7P1j. The weights for MURAT are not provided.
