...
predefined_data = {'abakan':np.load('data/abakan_compare_data.npy', allow_pickle=True),\
                   'omsk':np.load('data/abakan_compare_data.npy', allow_pickle=True)}

# REPLACE OMSK PREDEFINED
